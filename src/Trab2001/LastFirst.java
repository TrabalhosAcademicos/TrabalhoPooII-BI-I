...
public class LastFirst extends AdvancedRobot {
...
// Ao escanear um robô:
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
        ...
        if (name.indexOf("Hulk") != -1 || name.indexOf("Hulk") != -1) {
            return;
        }
...
// Se o Gavião bater em um inimigo: 
    ...
    private void x1() {
        ...
        setBodyColor(new Color(0,128,0));
        setGunColor(new Color(0,250,154));
        setRadarColor(new Color(0, 0, 0));
